...
public class ItemData : ScriptableObject
{
    ...
    [LabelText("ATK")] public ItemStatBonus attack = new ItemStatBonus();

    [FoldoutGroup("Stats/Battle Stats")]
    [LabelText("DEF")] public ItemStatBonus defense = new ItemStatBonus();

    [FoldoutGroup("Stats/Resource Stats")]
    [LabelText("HP")] public ItemStatBonus health = new ItemStatBonus();

    [FoldoutGroup("Stats/Resource Stats")]
    [LabelText("Mana")] public ItemStatBonus mana = new ItemStatBonus();

    [FoldoutGroup("Stats/Special Stats")]
    [LabelText("Crit %")] public ItemStatBonus critChance = new ItemStatBonus();

    [FoldoutGroup("Stats/Special Stats")]
    [LabelText("Atk Speed")] public ItemStatBonus attackSpeed = new ItemStatBonus();

    [FoldoutGroup("Stats/Special Stats")]
    [LabelText("Life Steal")] public ItemStatBonus lifeSteal = new ItemStatBonus();

    [FoldoutGroup("Stats/Special Stats")]
    [LabelText("Move Speed")] public ItemStatBonus speed = new ItemStatBonus();
    ...
    // RANDOMIZER
    [BoxGroup("Randomizer")]
    public ItemTierConfig tierConfig;
