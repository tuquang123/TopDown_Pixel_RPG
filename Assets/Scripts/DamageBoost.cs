...
public class DamageBoost : ISkill
{
    public void ExecuteSkill(PlayerStats playerStats, SkillData skillData)
    {
        ...
        int damageIncrease = playerStats.baseDamage * skillData.value / 100;  // Tăng sát thương theo value (ví dụ: value là 10 cho 10% tăng sát thương)
        playerStats.attack.AddModifier(new StatModifier(StatType.Attack, damageIncrease));  // Thêm modifier vào attack
